...
class FieldTimezoneServiceProvider extends ServiceProvider
{
  /**
  ...
  {
    $this->mergeConfigFrom(__DIR__.'/../config/fieldtimezone.php', 'fieldtimezone');

    // Register the service the package provides.
    $this->app->singleton('FieldTimezone', function ($app) {
      return new FieldTimezone;
    });
  }
  ...
  protected function bootForConsole()
  {
    ...
    $this->publishes([
        __DIR__.'/../config/fieldtimezone.php' => config_path('fieldtimezone.php'),
    ], 'fieldtimezone.config');
